...
import com.blueflybee.csambalib.R;
...
public class DocumentMetadata implements Serializable {
  ...
  public static Uri buildChildUri(Uri parentUri, DirectoryEntry entry) {
    switch (entry.getType()) {
      ...
      case DirectoryEntry.WORKGROUP:
      case DirectoryEntry.SERVER:
        System.out.println("uri111 buildParentUri entry.getName() = " + entry.getName());
        System.out.println("uri111 buildParentUri entry.getName() build = " + SMB_BASE_URI.buildUpon().authority(entry.getName()).build());
...
/*    final List<String> segments = childUri.getPathSegments();
    ...
    System.out.println("uri111 buildParentUri after = " + builder.build());
  ...
  public static DocumentMetadata createShare(String host, String share) {
    ...
    final Uri uri = Uri.parse("smb://" + host + "/" + share);
    System.out.println("uri111 = " + uri + "  host= " + host + "  share= " + share);
