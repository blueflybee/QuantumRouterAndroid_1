 ...
 * </pre>
 */
public class QueryDiskStateUseCase extends MultipleUseCase {
/*  private final RouterRepository routerRepository;
  ...
  @Inject
  public QueryDiskStateUseCase(RouterRepository routerRepository,
  ...
  protected Observable<QueryDiskStateResponse> buildUseCaseObservable(IRequest request) {
    ...
    Observable<QueryDiskStateResponse> routerObservable =
        routerRepository.queryDiskState(multiEncryptInfo.getRouterEncryptInfo())
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());

    Observable<QueryDiskStateResponse> cloudObservable =
        cloudRepository.queryDiskStateTrans(multiEncryptInfo.getCloudEncryptInfo())
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());
