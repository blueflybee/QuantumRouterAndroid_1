 ...
 * </pre>
 */
public class ConfigWifiUseCase extends MultipleUseCase {
  Observable<ConfigWifiResponse> result;
  @Inject
  public ConfigWifiUseCase(RouterRepository routerRepository,
  ...
  @Override
  protected Observable<ConfigWifiResponse> buildUseCaseObservable(IRequest request) {
    ...
    Observable<ConfigWifiResponse> routerObservable =
        routerRepository.configWifi(routerEncryptInfo)
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());

    IRequest cloudEncryptInfo = multiEncryptInfo.getCloudEncryptInfo();
    Observable<ConfigWifiResponse> cloudObservable =
        cloudRepository.configWifiTrans(cloudEncryptInfo)
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());
