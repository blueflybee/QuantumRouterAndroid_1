 ...
 * </pre>
 */
public class ModifyRouterDescUseCase extends UseCase {

  private final CloudRepository cloudRepository;

  @Inject
  public ModifyRouterDescUseCase(CloudRepository cloudRepository, ThreadExecutor threadExecutor,
  ...
  @Override
  protected Observable<ModifyRouterDescResponse> buildUseCaseObservable(IRequest request) {
    return cloudRepository.modifyRouterDesc(request);
  }
}
