 ...
 * </pre>
 */
public class GetWaitingAuthListUseCase extends MultipleUseCase {
  Observable<List<GetWaitingAuthDeviceListResponse>> result;
  @Inject
  public GetWaitingAuthListUseCase(RouterRepository routerRepository,
  ...
  @Override
  protected Observable<List<GetWaitingAuthDeviceListResponse>> buildUseCaseObservable(IRequest request) {
    QtecMultiEncryptInfo multiEncryptInfo = (QtecMultiEncryptInfo) request;

    Observable<List<GetWaitingAuthDeviceListResponse>> routerObservable =
        routerRepository.getWaitingAuthList(multiEncryptInfo.getRouterEncryptInfo())
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());

    Observable<List<GetWaitingAuthDeviceListResponse>> cloudObservable =
        cloudRepository.getWaitingAuthListTrans(multiEncryptInfo.getCloudEncryptInfo())
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());
