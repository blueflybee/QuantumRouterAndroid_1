 ...
 * </pre>
 */
public class SetWifiAllSwitchUseCase extends MultipleUseCase {
  Observable<SetWifiAllSwitchResponse> result;
  @Inject
  public SetWifiAllSwitchUseCase(RouterRepository routerRepository,
  ...
  @Override
  protected Observable<SetWifiAllSwitchResponse> buildUseCaseObservable(IRequest request) {
    QtecMultiEncryptInfo multiEncryptInfo = (QtecMultiEncryptInfo) request;

    Observable<SetWifiAllSwitchResponse> routerObservable =
        routerRepository.setWifiAllSwitch(multiEncryptInfo.getRouterEncryptInfo())
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());

    Observable<SetWifiAllSwitchResponse> cloudObservable =
        cloudRepository.setWifiAllSwitchTrans(multiEncryptInfo.getCloudEncryptInfo())
            .subscribeOn(Schedulers.from(threadExecutor))
            .observeOn(postExecutionThread.getScheduler());
