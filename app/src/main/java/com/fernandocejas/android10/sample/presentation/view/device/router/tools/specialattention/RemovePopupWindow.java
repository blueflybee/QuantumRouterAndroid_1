...
public class RemovePopupWindow extends PopupWindow implements View.OnClickListener {
  private View mView;
  ...
  public RemovePopupWindow(final Context context) {
    super(context);
    LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    mView = inflater.inflate(R.layout.dialog_remove_attention_pop, null);
    ...
    mDialogContent.setText("确定要移除关注吗？");
    mDialogTitle.setText("移除关注");
    mDialogPos.setText("确定");
