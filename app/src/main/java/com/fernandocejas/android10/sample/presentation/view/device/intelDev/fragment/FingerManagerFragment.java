 ...
 * </pre>
 */
public class FingerManagerFragment extends BaseFragment implements View.OnClickListener, IQueryFingerView,IDeleteFingerView {
  ...
  public static FingerManagerFragment newInstance() {
    FingerManagerFragment fragment = new FingerManagerFragment();
    return fragment;
  }
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_finger_manager, container, false);
  ...
  private String getLockId() {
    return getActivity().getIntent().getStringExtra(mNavigator.EXTRA_DEVICE_SERIAL_NO);
  }

  private String getRouterId() {
    return getActivity().getIntent().getStringExtra(mNavigator.EXTR_ROUTER_SERIAL_NUM);
  }
