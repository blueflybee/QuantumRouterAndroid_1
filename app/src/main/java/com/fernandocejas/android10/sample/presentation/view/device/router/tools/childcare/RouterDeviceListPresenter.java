 ...
 */
@PerActivity
public class RouterDeviceListPresenter implements Presenter {

  private final UseCase routerStatusUseCase;
  private RouterDeviceListView RouterStatusView;

  @Inject
  public RouterDeviceListPresenter(@Named(RouterUseCaseComm.ROUTER_STATUS) UseCase routerStatusUseCase) {
  ...
  public void setView(RouterDeviceListView RouterStatusView) {
