 ...
 */
@PerActivity
public class GetAntiQuestionPresenter implements Presenter {

    private final UseCase enableNetUseCase;
    private IGetAntiQuestionView enableNetView;

    @Inject
    public GetAntiQuestionPresenter(@Named(RouterUseCaseComm.GET_ANTI_QUESTION) UseCase enableNetUseCase) {
    ...
    public void setView(IGetAntiQuestionView enableNetView) {
