 ...
 */
@PerActivity
public class GetRouterListPresenter implements Presenter {

  private final UseCase routerListUseCase;

  private IGetRouterListView routerListView;

  @Inject
  public GetRouterListPresenter(@Named(CloudUseCaseComm.DEV_TREE) UseCase routerListUseCase) {
  ...
  public void setView(IGetRouterListView routerListView) {
