...
public class FingerprintListAdapter extends BaseAdapter {
  ...
  private List<GetFingerprintsResponse> mFingerprints = new ArrayList<>();


  public FingerprintListAdapter(@NonNull Context context) {
    this(context, true);
  }

  public FingerprintListAdapter(@NonNull Context context, boolean showDetail) {
    mContext = context;
  ...
  @Override
  public GetFingerprintsResponse getItem(int position) {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ViewHolder holder;
    GetFingerprintsResponse item = getItem(position);
    if (convertView == null) {
    ...
    holder.binding.tvName.setText(item.getFingerprintName());
  ...
  private class ViewHolder {
    ...
    public void bind(GetFingerprintsResponse fingerprint) {
      binding.executePendingBindings();
    }
  }

  public void update(List<GetFingerprintsResponse> fingerprints) {
    mFingerprints = fingerprints == null ? mFingerprints : fingerprints;
