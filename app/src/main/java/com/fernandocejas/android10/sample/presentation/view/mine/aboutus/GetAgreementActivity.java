...
public class GetAgreementActivity extends BaseActivity {
  ...
  private String url = "https://appdoc-3caretec.oss-cn-hangzhou.aliyuncs.com/userAgreement.htm";
  ...
  private void initData() {
    ...
    /*private String getAgreementContent(){
        return getIntent().getStringExtra(mNavigator.EXTR_AGREEMENT_CONTENT);
    }*/
