 ...
 */
@PerActivity
public class AddRouterPresenter_NetChange implements Presenter {

  private final UseCase searchRouterUseCase;
  private AddRouterView_NetChange addRouterView;

  @Inject
  public AddRouterPresenter_NetChange(
  ...
  public void setView(AddRouterView_NetChange intelDeviceListView) {
