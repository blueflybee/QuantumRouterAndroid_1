...
public class SafePeriodSetingAdapter extends CommAdapter1<String> {
  private int mIndexSelected = 0;
  private Context mContext;

  public SafePeriodSetingAdapter(Context context, List<String> data, int layoutId, int checkItemPosition) {
