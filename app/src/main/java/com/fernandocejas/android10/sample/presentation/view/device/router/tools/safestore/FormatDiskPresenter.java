 ...
 */
@PerActivity
public class FormatDiskPresenter implements Presenter {

    private final UseCase diskUseCase;
    private IFormatDiskView diskView;

    @Inject
    public FormatDiskPresenter(@Named(RouterUseCaseComm.FORMAT_DISK) UseCase diskUseCase) {
    ...
    public void setView(IFormatDiskView diskView) {
    ...
    public void formatDisk() {
        ...
        QtecMultiEncryptInfo multiEncryptInfo = EncryptInfoFactory.createMultiEncryptInfo(
            GlobleConstant.getgDeviceId(), routerData, RouterUrlPath.PATH_QUERY_DISK_STATE, RouterUrlPath.METHOD_POST);
