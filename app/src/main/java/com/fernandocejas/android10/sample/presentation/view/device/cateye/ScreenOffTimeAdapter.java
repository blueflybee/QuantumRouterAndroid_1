...
public class ScreenOffTimeAdapter extends CommAdapter1<String> {
  private int mIndexSelected = 0;
  private Context mContext;

  public ScreenOffTimeAdapter(Context context, List<String> data, int layoutId, int checkItemPosition) {
