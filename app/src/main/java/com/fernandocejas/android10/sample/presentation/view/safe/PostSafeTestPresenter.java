 ...
 */
@PerActivity
public class PostSafeTestPresenter implements Presenter {

    private final UseCase safeUseCase;
    private PostSafeTestView safeView;

    @Inject
    public PostSafeTestPresenter(@Named(RouterUseCaseComm.POST_SAFE_INSPECTION) UseCase safeUseCase) {
    ...
    public void setView(PostSafeTestView safeView) {
