 ...
 */
@PerActivity
public class PostMsgInvitationPresenter implements Presenter {
    ...
    @Inject
    public PostMsgInvitationPresenter(@Named(CloudUseCaseComm.DEAL_INVITATION) UseCase dealInvitationUseCase) {
