package com.fernandocejas.android10.sample.presentation.view.device.router.toolmenu.callback;
...
/***
 * MenuDragCallback该方法实现左边侧滑删除、长按拖动功能
 */
public class MenuDragCallback extends ItemTouchHelper.Callback {
  ...
  public MenuDragCallback(OnItemMoveListener onItemMoveListener) {
  ...
  public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder from, RecyclerView.ViewHolder target) {
    ...
    recyclerView.getAdapter().notifyItemMoved(from.getAdapterPosition(), target.getAdapterPosition());
    return true;
  }
...
//      viewHolder.itemView.setBackgroundColor(Color.LTGRAY);
    ...
    if (actionState == ItemTouchHelper.ACTION_STATE_DRAG) {
      ...
      mOnItemMoveListener.onItemMove(mFromPosition, mToPosition);
    }
  }
}
