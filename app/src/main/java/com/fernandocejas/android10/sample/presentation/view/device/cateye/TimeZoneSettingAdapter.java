...
public class TimeZoneSettingAdapter extends CommAdapter1<String> {
  private int mIndexSelected = 0;
  private Context mContext;

  public TimeZoneSettingAdapter(Context context, List<String> data, int layoutId, int checkItemPosition) {
