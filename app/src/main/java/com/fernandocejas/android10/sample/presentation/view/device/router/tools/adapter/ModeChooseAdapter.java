...
public class ModeChooseAdapter extends CommAdapter1<WaitAuthBean> {
  private int mIndexSelected = 0;
  private Context mContext;

  public ModeChooseAdapter(Context context, List<WaitAuthBean> data, int layoutId,int index) {
